...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
     ...
     KC_GRAVE, KC_1   , KC_2  , KC_3  , KC_4 , KC_5  , KC_6   ,                         KC_7  , KC_8  , KC_9   , KC_0  , KC_MINS, KC_EQL ,  KC_PSCR,
     KC_INS,   KC_TAB , CM_Q  , CM_W  , CM_F , CM_P  , CM_G   ,                         CM_J  , CM_L  , CM_U   , CM_Y  , CM_SCLN, KC_LBRC,  KC_RBRC,
     KC_LALT,  KC_CAPS, CM_A  , CM_R  , CM_S , CM_T  , CM_D   ,                         CM_H  , CM_N  , CM_E   , CM_I  , CM_O   , KC_QUOT,  KC_BSLS,
     KC_LCTL,  KC_LSFT, CM_Z  , CM_X  , CM_C , CM_V  , CM_B   ,                         CM_K  , CM_M  , KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,  KC_ALGR,
  ...
  [1] = LAYOUT(
     ...
     _______, _______,_______,_______,_______,_______,_______,                        KC_LPRN, KC_P7 , KC_P8 , KC_P9 ,KC_PSLS,_______,CM_HARD, 
  ...
  [2] = LAYOUT(
      _______,_______,_______,_______,_______,KC_BRID,KC_BRIU,                        KC_VOLD,KC_VOLU,KC_MPRV,KC_MPLY,KC_MNXT,_______,RESET , 
      _______,_______,_______,_______,_______,_______,_______,                        _______,_______,_______,_______,_______,_______,CM_HARD, 
